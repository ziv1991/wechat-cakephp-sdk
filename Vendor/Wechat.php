 ...
 *  根据项目使用针对cakephp进行了修改
 *  @author lukechen
 *  @link https://github.com/CheerChen/wechat-cakephp-sdk
 *  @version 1.2
 *  @example
...
Class WechatCache {
    ...
    static function set($key, $value, $expire) {
...
<Nonce><![CDATA[%s]]></Nonce>
    ...
    public function checkAuth($appid = '', $appsecret = '', $token = '') {
        ...
        //获取缓存
        if (!$this->access_token = WechatCache::get('token_' . $appid)) {
